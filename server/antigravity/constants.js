...
// Gemini-specific limits (Google API rejects > 8192 for most models)
...
export const OAUTH_CONFIG = {
    clientId: process.env.GOOGLE_OAUTH_CLIENT_ID || 'YOUR_CLIENT_ID',
    clientSecret: process.env.GOOGLE_OAUTH_CLIENT_SECRET || 'YOUR_CLIENT_SECRET',
