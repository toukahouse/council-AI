...
def create_chat(org_id, model=None):
    rate_limit()
    payload = {"name": ""}
    if model:
        payload["model"] = model
...
class ClaudeProxyHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/v1/models":
            models = [
                {"id": "claude-sonnet-5", "object": "model", "created": 1750000000, "owned_by": "anthropic"},
                {"id": "claude-haiku-4-5-20251001", "object": "model", "created": 1747000000, "owned_by": "anthropic"},
                {"id": "claude-sonnet-4-6", "object": "model", "created": 1748000000, "owned_by": "anthropic"},
                {"id": "claude-fable-5", "object": "model", "created": 1750000000, "owned_by": "anthropic"},
                {"id": "claude-opus-5", "object": "model", "created": 1750000000, "owned_by": "anthropic"},
                {"id": "claude-opus-4-8", "object": "model", "created": 1749000000, "owned_by": "anthropic"},
                {"id": "claude-opus-4-7", "object": "model", "created": 1748000000, "owned_by": "anthropic"},
                {"id": "claude-opus-4-6", "object": "model", "created": 1747000000, "owned_by": "anthropic"},
    ...
    def do_POST(self):
        ...
        chat_id = create_chat(ORGANIZATION_ID, model=model)
        if not chat_id:
